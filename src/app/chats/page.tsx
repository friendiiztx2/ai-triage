                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-2 py-3 text-center">
                          {(() => {
                            const raw = ((chat.conversation || '') + ' ' + (chat.summary || '') + ' ' + (chat.category_id || '')).toLowerCase();
                            if (raw.includes('ถอน')) {
                              return (
                                <span className="inline-flex items-center gap-1 text-[11px] font-extrabold px-2 py-1 rounded-lg bg-amber-50 text-amber-700 border border-amber-200 dark:bg-amber-955/30 dark:text-amber-300 dark:border-amber-900/50 shadow-sm whitespace-nowrap">
                                  💸 ถอนเงิน
                                </span>
                              );
                            }
                            if (raw.includes('ฝาก') || raw.includes('โอน')) {
                              return (
                                <span className="inline-flex items-center gap-1 text-[11px] font-extrabold px-2 py-1 rounded-lg bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-955/30 dark:text-emerald-300 dark:border-emerald-900/50 shadow-sm whitespace-nowrap">
                                  💵 ฝากเงิน
                                </span>
                              );
                            }
                            if (raw.includes('สลิป') || raw.includes('ยอดไม่เข้า')) {
                              return (
                                <span className="inline-flex items-center gap-1 text-[11px] font-extrabold px-2 py-1 rounded-lg bg-indigo-50 text-indigo-700 border border-indigo-200 dark:bg-indigo-955/30 dark:text-indigo-300 dark:border-indigo-900/50 shadow-sm whitespace-nowrap">
                                  💳 ตรวจสอบสลิป
                                </span>
                              );
                            }
                        ...
                        <td className="px-2 py-3 text-center">
                          {(() => {
                            ...
                            if (tags.includes('#VIP')) {
                              return (
                                <span className="inline-flex items-center gap-1 text-[11px] font-extrabold px-2 py-1 rounded-lg bg-purple-50 text-purple-700 border border-purple-200 dark:bg-purple-955/30 dark:text-purple-300 dark:border-purple-900/50 shadow-sm whitespace-nowrap">
                                  👑 VIP
                                </span>
                              );
                            }
                            if (raw.includes('โปร') || raw.includes('โบนัส') || raw.includes('เครดิตฟรี') || chat.category_id === 'promo_bonus') {
                              return (
                                <span className="inline-flex items-center gap-1 text-[11px] font-extrabold px-2 py-1 rounded-lg bg-rose-50 text-rose-700 border border-rose-200 dark:bg-rose-955/30 dark:text-rose-300 dark:border-rose-900/50 shadow-sm whitespace-nowrap">
                                  📣 โปรโมชัน
                                </span>
                              );
                            }
                            if (tags.includes('#กิจกรรม') || raw.includes('กิจกรรม')) {
                              return (
                                <span className="inline-flex items-center gap-1 text-[11px] font-extrabold px-2 py-1 rounded-lg bg-sky-50 text-sky-700 border border-sky-200 dark:bg-sky-955/30 dark:text-sky-300 dark:border-sky-900/50 shadow-sm whitespace-nowrap">
                                  🎁 กิจกรรม
                                </span>
                              );
                            }
