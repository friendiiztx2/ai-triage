  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-100 tracking-tight font-display">{language === 'th' ? 'จัดการหมวดหมู่ปัญหา (Category Manager)' : 'Manage Categories'}</h1>
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">{language === 'th' ? 'ตั้งค่าและดูรายการหมวดหมู่ปัญหาหลักที่ใช้ประเมินผลด้วย AI' : 'Configure main category mappings evaluated by AI'}</p>
        </div>
